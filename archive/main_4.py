...
def open_menu(menu_type, name, balance):
    ...
    name_label = tk.Label(menu_window, text="Name:", bg=menu_bg_color, fg=button_bg_color)
    name_label.grid(row=0, column=0, padx=5, pady=5, sticky="e")
    name_entry = tk.Entry(menu_window, state='readonly', textvariable=tk.StringVar(menu_window, value=name), bg=menu_bg_color, fg=button_bg_color)
    name_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")

    balance_label = tk.Label(menu_window, text="Balance:", bg=menu_bg_color, fg=button_bg_color)
    balance_label.grid(row=0, column=2, padx=5, pady=5, sticky="e")
    balance_entry = tk.Entry(menu_window, state='readonly', textvariable=tk.StringVar(menu_window, value=balance), bg=menu_bg_color, fg=button_bg_color)
    balance_entry.grid(row=0, column=3, padx=5, pady=5, sticky="w")

    # Populate the "Drink" field with the name of the menu
    drink_label = tk.Label(menu_window, text="Drink:", bg=menu_bg_color, fg=button_bg_color)
    drink_label.grid(row=1, column=0, padx=5, pady=5, sticky="e")
    drink_entry = tk.Entry(menu_window, state='readonly', bg=menu_bg_color, fg=button_bg_color)
    ...
    price_label = tk.Label(menu_window, text="Price:", bg=menu_bg_color, fg=button_bg_color)
    price_label.grid(row=1, column=2, padx=5, pady=5, sticky="e")
    price_entry = tk.Entry(menu_window, state='readonly', bg=menu_bg_color, fg=button_bg_color)
    ...
    shots_label = tk.Label(menu_window, text="Shots:", bg=menu_bg_color, fg=button_bg_color)
    ...
    amount_label = tk.Label(menu_window, text="Amount (oz):", bg=menu_bg_color, fg=button_bg_color)
    ...
    percentage_label = tk.Label(menu_window, text="Alcohol Percentage:", bg=menu_bg_color, fg=button_bg_color)
    percentage_label.grid(row=4, column=0, padx=5, pady=5, sticky="e")
    percentage_entry = tk.Entry(menu_window, state='readonly', bg=menu_bg_color, fg=button_bg_color)
...
name_label_main = tk.Label(root, text="Name:", bg=menu_bg_color, fg=button_bg_color)
name_label_main.grid(row=0, column=0, padx=5, pady=5, sticky="e")
name_entry_main = tk.Entry(root, textvariable=name_var, state='readonly', bg=menu_bg_color, fg=button_bg_color)
name_entry_main.grid(row=0, column=1, padx=5, pady=5, sticky="w")

balance_label_main = tk.Label(root, text="Balance:", bg=menu_bg_color, fg=button_bg_color)
balance_label_main.grid(row=0, column=2, padx=5, pady=5, sticky="e")
balance_entry_main = tk.Entry(root, textvariable=balance_var, state='readonly', bg=menu_bg_color, fg=button_bg_color)
